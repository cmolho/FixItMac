      ...
      confirmPopup.then(function(result) {
        if(result) {
          ...
          if (rand === 1) {
            ...
            document.location.href = "#/rewardSquirrel/";
          }
          else if (rand === 4) {
            document.location.href = "#/rewardPrinterJoke/";
          }
          else if (rand === 5) {
            document.location.href = "#/rewardCopierJoke/";
          }
          else if (rand === 6) {
            document.location.href = "#/rewardTonerJoke/";
          }
        }
      });
    };
